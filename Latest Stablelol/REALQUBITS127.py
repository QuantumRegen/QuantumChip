...
print("Kicking off—127-Qubit IBM Quantum Test for UFT (10s Awesome Push)...")

n_qubits = 127
shots = 512
time_steps = np.logspace(-6, -3, 11)
T2_avg = 100e-6
fidelity_init = 0.99
regen_time_qubit = 1e-7  # 0.1 µs resets
...
for t in time_steps:
    try:
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(f'/home/wayne/Desktop/ibm_127qubit_t{t:.1e}.png')
        plt.close()
