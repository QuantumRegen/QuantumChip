...
bond_dim = 2
b_field_strength = 0.3  # Adjustable vortex spin B-field strength (tweak this value)
noise_scale = 0.05  # Noise amplitude (adjust for noise level)
...
for t in range(steps):
    ...
    uptime_flag = 1 if abs(coherence) > 0.5 else 0  # Adjust threshold if needed
...
plt.savefig('titan_sik_simulation_with_bfield_noise.png')
plt.show()
